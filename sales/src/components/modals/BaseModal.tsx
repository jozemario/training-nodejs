...
export default () => (
    <div className="relative flex flex-col items-center max-w-lg gap-4 p-6 rounded-md shadow-md sm:py-8 sm:px-12 dark:dark:bg-gray-900 dark:dark:text-gray-100">
        ...
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
            className="w-40 h-40 fill-current shrink-0 dark:dark:text-violet-400"
        >
        ...
        <p className="flex-1 text-center dark:dark:text-gray-400">
            Tempora ipsa quod magnam non, dolores nemo optio. Praesentium soluta
            maiores non itaque aliquam sint.
        </p>
        <button
            type="button"
            className="px-8 py-3 font-semibold rounded-full dark:dark:bg-violet-400 dark:dark:text-gray-900"
        >
            Start recycling
        </button>
    </div>
