...
export default () => {
    return (
        <div className="container p-2 mx-auto rounded-md sm:p-4 text-gray-100 bg-gray-900">
            ...
            <div className="overflow-x-auto">
                <table className="min-w-full text-xs">
                    ...
                    <tbody>
                        <tr className="text-right border-b border-opacity-20 border-gray-700 bg-gray-800">
