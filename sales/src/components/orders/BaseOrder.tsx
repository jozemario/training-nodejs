...
export default () => (
    <div className="flex flex-col max-w-md p-6 space-y-4 divide-y sm:w-96 sm:p-10 divide-gray-700 dark:dark:bg-gray-900 dark:dark:text-gray-100">
        <h2 className="text-2xl font-semibold">Order items</h2>
        <ul className="flex flex-col pt-4 space-y-2">
            <li className="flex items-start justify-between">
                <h3>
                    Hard taco, chicken
                    <span className="text-sm dark:dark:text-violet-400">
                        x3
                    </span>
                </h3>
            ...
            <div>
                ...
                <div className="flex items-center space-x-2 text-xs">
                    <svg
                        ...
                        viewBox="0 0 512 512"
                        className="w-3 h-3 mt-1 fill-current dark:dark:text-violet-400"
                    >
        ...
        <div className="pt-4 space-y-2">
            ...
            <div className="flex flex-col">
                ...
                <a
                    ...
                    href="#"
                    className="text-xs hover:underline dark:dark:text-violet-400"
                >
            ...
            <div className="space-y-6">
                ...
                <button
                    type="button"
                    className="w-full py-2 font-semibold border rounded dark:dark:bg-violet-400 dark:dark:text-gray-900 dark:dark:border-violet-400"
                >
                    Go to checkout
                </button>
            </div>
